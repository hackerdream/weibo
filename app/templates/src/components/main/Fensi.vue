    ...
    <div>
        <div class="manager">
            <div class="manager-box">
                ...
                <div class="fensi">
                    <div class="fensi-box">
                        <div class="fensi-name">
                            <span>
                                全部粉丝 ：93
                            </span>
                        </div>
                        <ul class="fensi-list">
                            <li class="fensi-list-box" v-for="follower in followers">
                                <div class="list-detail">
                                    <div class="list-face">
                                        <router-link :to="{ name : 'home' ,params:{id:follower.id}}">
                                    ...
                                    <div class="list-info">
                                        ...
                                        <div class="status">{{follower.rel}}</div>
                                        <div class="summary">
                                            <span>吃饭睡觉打豆豆</span>
                                        </div>
                                    </div>
